...
# 3. Identifikasi Isu Berbasis Bukti

## 3.1 Data Tidak Otomatis Menjadi Masalah

Data merupakan informasi mengenai suatu kondisi. Keberadaan data tidak secara otomatis menunjukkan bahwa kondisi tersebut merupakan masalah.
...
# 5. Kerangka Alur Berpikir: Observe → Explore → Validate → Frame
...
Pada tahap ini mahasiswa tidak perlu langsung menyatakan:

> "Ini adalah masalah."

Mahasiswa cukup mengidentifikasi kondisi yang menunjukkan adanya sesuatu yang layak diperhatikan.

---

## 6.2 Sumber Fenomena

Fenomena dapat ditemukan dari berbagai sumber, antara lain:
...
* portal data;
* hasil pengamatan;
* sumber informasi kredibel lainnya.
...
Misalnya ditemukan informasi:

> Waktu tempuh perjalanan pada salah satu koridor perkotaan meningkat pada jam sibuk.

Pada tahap Observe, mahasiswa cukup mencatat:
...
Kesimpulan tersebut membutuhkan eksplorasi lebih lanjut.

---

# 7. Explore — Mengeksplorasi Fenomena
...
* koridor tertentu;
* kawasan permukiman;
* wilayah sekitar fasilitas publik.

Lokasi membantu mempersempit isu yang terlalu luas.
...
* Apakah muncul setelah suatu perubahan tertentu?

Dimensi waktu penting untuk membedakan fenomena sesaat dengan persoalan yang berulang.
...
Skala dapat dinyatakan melalui:
...
# 9. Validate — Memvalidasi dengan Bukti
...
# 11. Hubungan Claim dan Evidence
...
Apakah sumber berasal dari lembaga yang memiliki kewenangan atau kompetensi terhadap informasi tersebut?

### 2. Kapan diterbitkan?

Apakah informasi masih relevan dengan periode penelitian?

### 3. Periode datanya kapan?

Tanggal publikasi dan tahun data tidak selalu sama.

Contoh:

> Artikel diterbitkan tahun 2025 tetapi menggunakan data tahun 2022.

Keduanya perlu dicatat secara terpisah.
...
Angka yang terlihat sama belum tentu mengukur hal yang sama.

### 6. Bagaimana data diperoleh?
...
# 15. Validate sebagai Proses Iteratif
...
## Kesalahan 5 — Mengabaikan tahun data

Data lama belum tentu tidak berguna, tetapi mahasiswa harus mengetahui periode datanya dan mempertimbangkan relevansinya.
...
## Kesalahan 7 — Isu terlalu luas

> "Masalah sampah di Kota X."
...
## Kesalahan 8 — Langsung mencari solusi

> "Masalahnya perlu aplikasi."

Teknologi bukan jawaban sebelum persoalannya dipahami.

---

## Kesalahan 9 — Langsung mencari akar masalah

> "Masalah terjadi karena pemerintah tidak efektif."

Pernyataan tersebut sudah merupakan klaim mengenai penyebab dan membutuhkan analisis yang berbeda.
